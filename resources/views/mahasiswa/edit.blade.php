        ...
        <div class="row">
            <form action="/mahasiswa/{{$mahasiswa->id}}/update" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="nama" type="text" class="formcontrol" id="exampleInputEmail1"
                        ariadescribedby="EmailHelp" placeholder="Nama Mahasiswa" value="{{$mahasiswa->nama}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">NIM</label>
                    <input name="nim" type="text" class="formcontrol" id="exampleInputEmail1"
                        ariadescribedby="EmailHelp" placeholder="Nomor Induk Mahasiswa" value="{{$mahasiswa->nim}}">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Alamat</label>
                    <textarea name="alamat" class="formcontrol" id="exampleFormControlTextarea1" rows="3"
